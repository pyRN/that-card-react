        ...
        <div align="center" className="justify-content-center mt-5">
            {
                bIsLoggedIn ?
                    <div className="form-signin border border-danger bg-dark rounded">
                        <h1 className="h3 mb-3 font-weight-normal text-danger">Do you want to logout</h1>
                        <button id="registerBtn" className="btn btn-lg btn-danger btn-block mt-3" type="submit" onClick={handleOnLogout}>Logout</button>
                    </div>
